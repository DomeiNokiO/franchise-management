...
class IngredientController extends Controller
{
    ...
    {
        $ingredients = Ingredient::withCount(['stocks', 'recipes'])->latest()->paginate(25);
        return view('catalog.ingredients.index', compact('ingredients'));
    }

    public function create(): View { $this->ownerOnly(); return view('catalog.ingredients.form', ['ingredient' => new Ingredient]); }
    ...
    public function edit(Ingredient $ingredient): View { $this->ownerOnly(); return view('catalog.ingredients.form', compact('ingredient')); }
